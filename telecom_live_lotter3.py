...
# cron "*/10 8-20 * * *" script-path=xxx.py,tag=匹配cron用
# const $ = new Env('某营业厅直播抽奖3');
# -------------------------------
"""
1. 脚本仅供学习交流使用, 请在下载后24h内删除
2. 环境变量说明:
    必须  TELECOM_PHONE3 : 电信手机号
    必须  TELECOM_PASSWORD3 : 电信服务密码
...
from china_telecom3 import ChinaTelecom
...
def main(phone, password):
    apiType = 1
    try:
        url = "https://raw.githubusercontent.com/liangzad/telecomLiveInfo/main/telecomLiveInfo.json"
...
if __name__ == '__main__':
    phone = get_environ("TELECOM_PHONE3")
    password = get_environ("TELECOM_PASSWORD3")
